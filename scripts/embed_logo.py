...
logo_source = project_dir / "assets" / "fluidnc-logo.png"
target = project_dir / "include" / "generated" / "fluidNC_logo_png.h"
...
constexpr uint32_t kFluidNCLogoWidth = {logo_width};
constexpr uint32_t kFluidNCLogoHeight = {logo_height};
constexpr size_t kFluidNCLogoPixelCount = {len(logo_pixels)};
constexpr uint32_t kFluidNCLogoHeaderWidth = {header_width};
constexpr uint32_t kFluidNCLogoHeaderHeight = {header_height};
constexpr size_t kFluidNCLogoHeaderPixelCount = {len(header_pixels)};

const uint16_t kFluidNCLogoPixels[] PROGMEM = {{
{format_pixels(logo_pixels)}
}};

const uint16_t kFluidNCLogoHeaderPixels[] PROGMEM = {{
